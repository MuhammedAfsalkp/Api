...
class CategoryRoutes extends common_routes_1.default {
    ...
    configRoutes() {
        ...
        this.app.post('/category', [trimRequest.all, category_middleware_1.default.validateCreateItem, category_controller_1.default.createItem]);
        this.app.patch('/category/:id', [trimRequest.all, category_middleware_1.default.validateUpdateItem, category_controller_1.default.updateItem]);
        this.app.delete('/category/:id', [trimRequest.all, category_middleware_1.default.validateDeleteItem, category_controller_1.default.deleteItem]);
        //return this.app;
    }
}
